...
export default function Now(currentlyReading) {
  ...
  var TiansuyBirthDate = '1999-10-27'
  var birthDate = new Date(TiansuyBirthDate)

  var TiansuyAge = year - birthDate.getFullYear()

  var TiansuyMonth = 0
  if (month >= birthDate.getMonth()) TiansuyMonth = month - birthDate.getMonth()
  else {
    TiansuyAge--
    TiansuyMonth = 12 + month - birthDate.getMonth()
  }

  var TiansuyDay = 0
  if (date >= birthDate.getDate()) TiansuyDay = date - birthDate.getDate()
  else {
    TiansuyMonth--
    TiansuyDay = 31 + date - birthDate.getDate()
    if (TiansuyMonth < 0) {
      TiansuyMonth = 11
      TiansuyAge--
    }
        ...
        <div>
          <div className="flex justify-between gap-5">
            <div className="mt-2 mb-10 w-1/2 rounded-md border border-gray-600 p-1 text-sm dark:border-gray-200">
              <span className="ml-2 font-semibold">Location:</span> <span>United States, TX</span>
              <br />
              <span className="ml-2 font-semibold">Weather:</span>{' '}
              <span>
                <a
                  href="https://weather.com/en-GB/weather/today/l/83cda9fc80bff5810fddd0caf822ff85fa86ee65652061b3069426f31d9e9d2c"
                  target="_blank"
