                ...
                <tr key={post.slug} className="group hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="relative whitespace-nowrap px-6 py-4 text-sm">
                    <div className="flex items-center">
                      ...
                      <div className="absolute left-16 -mx-2 -my-[0.85rem] flex items-center bg-gray-50 px-2 py-[0.85rem] opacity-0 transition-all duration-200 group-hover:opacity-100 dark:bg-gray-700">
                        <button
      ...
      {deleteTarget && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="w-full max-w-sm rounded-lg bg-white p-6 dark:bg-gray-800">
            <h3 className="mb-4 text-lg font-medium text-gray-900 dark:text-white">确认删除</h3>
